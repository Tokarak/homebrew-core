class S6 < Formula
  ...
  url "https://skarnet.org/software/s6/s6-2.12.0.4.tar.gz", using: :homebrew_curl
  ...
  resource "skalibs" do
    url "https://skarnet.org/software/skalibs/skalibs-2.14.1.1.tar.gz", using: :homebrew_curl
    sha256 "b6b79b816f4ba0b6801676b0ed4179b59c8c7809eeffe26db672e404636befc3"
  end

  resource "execline" do
    url "https://skarnet.org/software/execline/execline-2.9.5.0.tar.gz", using: :homebrew_curl
